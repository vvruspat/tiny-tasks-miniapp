...
type ProjectReducerActionsFail =
  | GetProjectListFailedAction
  | GetProjectFailedAction
  | CreateProjectFailedAction
  | UpdateProjectFailedAction
  | RemoveProjectFailedAction;
type ProjectReducerActionsFetch =
  | GetProjectListFetchingAction
  | GetProjectFetchingAction
  | CreateProjectFetchingAction
  | UpdateProjectFetchingAction
  | RemoveProjectFetchingAction;

export type ProjectReducerActions =
  | ProjectReducerActionsSuccess
  | ProjectReducerActionsFail
  | ProjectReducerActionsFetch;
